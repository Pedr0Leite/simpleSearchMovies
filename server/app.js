...
request(url, (err, response, body)=>{
    if(err){
        res.render('index', {movieResult:null, error:'Error, please try another movie name again!'});
    }else{
...
movieJSON.Search.forEach(movie => {
    movieTitles.push({"Title": movie.Title, "Poster":movie.Poster, "Year":movie.Year});
